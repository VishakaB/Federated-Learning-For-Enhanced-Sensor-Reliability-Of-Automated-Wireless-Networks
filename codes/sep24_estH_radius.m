...
mean_outage_estH = zeros(1,total_radius);
mean_variance_estH = zeros(1,total_radius); %average variance of the system per time unit
mean_optimal_cost_estH = zeros(1,total_radius);
mean_avg_replacement_cost_estH = zeros(1,total_radius);
mean_avg_comm_cost_estH = zeros(1,total_radius);
mean_LL_estH = zeros(1,total_radius);

mean_outageestH_rng = zeros(total_states,total_radius);
mean_varianceestH_rng = zeros(total_states,total_radius);
data_count_estH_rng = zeros(total_states,total_radius);
mean_optimal_costestH_rng = zeros(total_states,total_radius);
mean_avg_replacement_costestH_rng = zeros(total_states,total_radius);
meamean_LL_estH_rng = zeros(total_states,total_radius);
total_no_robots = 10;
